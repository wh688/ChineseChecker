...
import chinesechecker.client.IllegalMove;
...
public class StateTest {
    ...
    public void testRedSingleMove() {
    	...
    	PlayerInfo [] playerInfo = {player1, player2};
    	State state = new State(playerInfo);	
    	state.chessBoard.Go(state.getChessBoard().getChess(0), new Position(5,9));
    	state.chessBoard.Go(state.getChessBoard().getChess(1), new Position(7,7));
    	state.chessBoard.Go(state.getChessBoard().getChess(2), new Position(7,9));
    	state.chessBoard.Go(state.getChessBoard().getChess(3), new Position(8,8));
    	state.chessBoard.Go(state.getChessBoard().getChess(4), new Position(10,8));
    	state.chessBoard.Go(state.getChessBoard().getChess(5), new Position(10,11));
    	state.chessBoard.Go(state.getChessBoard().getChess(6), new Position(11,12));
    	state.chessBoard.Go(state.getChessBoard().getChess(7), new Position(13,11));
    	state.chessBoard.Go(state.getChessBoard().getChess(8), new Position(13,13));
    	state.chessBoard.Go(state.getChessBoard().getChess(9), new Position(13,10));
    	state.chessBoard.Go(state.getChessBoard().getChess(10), new Position(13,12));
    	state.chessBoard.Go(state.getChessBoard().getChess(11), new Position(12,10));
    	state.chessBoard.Go(state.getChessBoard().getChess(12), new Position(10,10));
    	state.chessBoard.Go(state.getChessBoard().getChess(13), new Position(9,11));
    	state.chessBoard.Go(state.getChessBoard().getChess(14), new Position(9,8));
    	state.chessBoard.Go(state.getChessBoard().getChess(15), new Position(8,7));
    	state.chessBoard.Go(state.getChessBoard().getChess(16), new Position(4,8));
    	state.chessBoard.Go(state.getChessBoard().getChess(17), new Position(4,6));
    	state.chessBoard.Go(state.getChessBoard().getChess(18), new Position(2,5));
    	state.chessBoard.Go(state.getChessBoard().getChess(19), new Position(1,5));
    ...
    public void testRedContinousJump() {
    	...
    	PlayerInfo [] playerInfo = {player1, player2};
    	State state = new State(playerInfo);	
    	state.chessBoard.Go(state.getChessBoard().getChess(0), new Position(5,6));
    	state.chessBoard.Go(state.getChessBoard().getChess(1), new Position(5,9));
    	state.chessBoard.Go(state.getChessBoard().getChess(2), new Position(7,7));
    	state.chessBoard.Go(state.getChessBoard().getChess(3), new Position(7,9));
    	state.chessBoard.Go(state.getChessBoard().getChess(4), new Position(8,8));
    	state.chessBoard.Go(state.getChessBoard().getChess(5), new Position(10,11));
    	state.chessBoard.Go(state.getChessBoard().getChess(6), new Position(11,12));
    	state.chessBoard.Go(state.getChessBoard().getChess(7), new Position(12,10));
    	state.chessBoard.Go(state.getChessBoard().getChess(8), new Position(13,10));
    	state.chessBoard.Go(state.getChessBoard().getChess(9), new Position(13,13));
    	state.chessBoard.Go(state.getChessBoard().getChess(10), new Position(13,11));
    	state.chessBoard.Go(state.getChessBoard().getChess(11), new Position(13,12));
    	state.chessBoard.Go(state.getChessBoard().getChess(12), new Position(10,8));
    	state.chessBoard.Go(state.getChessBoard().getChess(13), new Position(10,10));
    	state.chessBoard.Go(state.getChessBoard().getChess(14), new Position(9,8));
    	state.chessBoard.Go(state.getChessBoard().getChess(15), new Position(9,11));
    	state.chessBoard.Go(state.getChessBoard().getChess(16), new Position(8,6));
    	state.chessBoard.Go(state.getChessBoard().getChess(17), new Position(4,6));
    	state.chessBoard.Go(state.getChessBoard().getChess(18), new Position(4,8));
    	state.chessBoard.Go(state.getChessBoard().getChess(19), new Position(2,5));
    	state.currentPlayIndex = 0;
    	String expectedstr = "1\n" + 
    			"EEEEEEEEEEEEEEEEE\n"+
    			"EEEE19BEEEEEEEEEEEE\n" + 
    ...
    public void testRedWin() {
    	...
    	PlayerInfo [] playerInfo = {player1, player2};
    	State state = new State(playerInfo);
    	state.chessBoard.Go(state.getChessBoard().getChess(10), new Position(8,8));
    	state.chessBoard.Go(state.getChessBoard().getChess(11), new Position(7,8));
    	state.chessBoard.Go(state.getChessBoard().getChess(12), new Position(7,7));
    	state.chessBoard.Go(state.getChessBoard().getChess(13), new Position(6,8));
    	state.chessBoard.Go(state.getChessBoard().getChess(14), new Position(6,7));
    	state.chessBoard.Go(state.getChessBoard().getChess(15), new Position(6,6));
    	state.chessBoard.Go(state.getChessBoard().getChess(16), new Position(5,8));
    	state.chessBoard.Go(state.getChessBoard().getChess(17), new Position(5,7));
    	state.chessBoard.Go(state.getChessBoard().getChess(18), new Position(5,6));
    	state.chessBoard.Go(state.getChessBoard().getChess(19), new Position(5,5));
    	state.chessBoard.Go(state.getChessBoard().getChess(0), new Position(13,10));
    	state.chessBoard.Go(state.getChessBoard().getChess(1), new Position(14,11));
    	state.chessBoard.Go(state.getChessBoard().getChess(2), new Position(14,12));
    	state.chessBoard.Go(state.getChessBoard().getChess(3), new Position(14,13));
    	state.chessBoard.Go(state.getChessBoard().getChess(4), new Position(15,11));
    	state.chessBoard.Go(state.getChessBoard().getChess(5), new Position(15,12));
    	state.chessBoard.Go(state.getChessBoard().getChess(6), new Position(15,13));
    	state.chessBoard.Go(state.getChessBoard().getChess(7), new Position(16,12));
    	state.chessBoard.Go(state.getChessBoard().getChess(8), new Position(16,13));
    	state.chessBoard.Go(state.getChessBoard().getChess(9), new Position(17,13));
    	state.currentPlayIndex = 0;
    	String expectedstr = "0\n" + 
    			"EEEEEEEEEEEEEEEEE\n" + 
    			"EEEEEEEEEEEEEEEEE\n" + 
    ...
    public void testBlueWin() {
    	...
    	PlayerInfo [] playerInfo = {player1, player2};
    	State state = new State(playerInfo);	
    	state.chessBoard.Go(state.getChessBoard().getChess(0), new Position(10,10));
    	state.chessBoard.Go(state.getChessBoard().getChess(1), new Position(11,10));
    	state.chessBoard.Go(state.getChessBoard().getChess(2), new Position(11,11));
    	state.chessBoard.Go(state.getChessBoard().getChess(3), new Position(12,10));
    	state.chessBoard.Go(state.getChessBoard().getChess(4), new Position(12,11));
    	state.chessBoard.Go(state.getChessBoard().getChess(5), new Position(12,12));
    	state.chessBoard.Go(state.getChessBoard().getChess(6), new Position(13,10));
    	state.chessBoard.Go(state.getChessBoard().getChess(7), new Position(13,11));
    	state.chessBoard.Go(state.getChessBoard().getChess(8), new Position(13,12));
    	state.chessBoard.Go(state.getChessBoard().getChess(9), new Position(13,13));
    	state.chessBoard.Go(state.getChessBoard().getChess(10), new Position(5,8));
    	state.chessBoard.Go(state.getChessBoard().getChess(11), new Position(4,7));
    	state.chessBoard.Go(state.getChessBoard().getChess(12), new Position(4,6));
    	state.chessBoard.Go(state.getChessBoard().getChess(13), new Position(4,5));
    	state.chessBoard.Go(state.getChessBoard().getChess(14), new Position(3,7));
    	state.chessBoard.Go(state.getChessBoard().getChess(15), new Position(3,6));
    	state.chessBoard.Go(state.getChessBoard().getChess(16), new Position(3,5));
    	state.chessBoard.Go(state.getChessBoard().getChess(17), new Position(2,6));
    	state.chessBoard.Go(state.getChessBoard().getChess(18), new Position(2,5));
    	state.chessBoard.Go(state.getChessBoard().getChess(19), new Position(1,5));
    	state.currentPlayIndex = 1;
    	String expectedstr = "1\n" + 
